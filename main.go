...
//func main(){
//	fmt.Println("Ready to hack!")
//	server := &http.Server{
//		Addr: ":8080",
//		Handler: http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
//			if r.Method == http.MethodConnect {
//				handler.ProxyHttps(w, r)
//			} else {
//				handler.ProxyHttp(w, r)
//			}
//		}),
//		TLSNextProto: make(map[string]func(*http.Server, *tls.Conn, http.Handler)),
//	}
//	server.ListenAndServe()
//	server.ListenAndServeTLS("./Sertificate/OS/ca.crt", "./Sertificate/OS/ca.key")
//}
...
func (w *cloudToButtResponse) Write(p []byte) (int, error) {
	...
	if len(pathQueue)>0{
		Repeater.SaveRespstr(string(p), pathQueue[0])
		if strings.Contains(string(p), "</html>") || strings.Contains(string(p), "</HTML>"){
...
func cloudToButt(upstream http.Handler) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		pathQueue=append(pathQueue, fname)
